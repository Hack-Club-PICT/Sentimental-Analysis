    ...
    render() {
      ...
      return (
        <div>
          ...
          fontSize: "16px", padding: "15px 10px"}}
                className={classnames({ active: this.state.activeTab === '1' })}
                onClick={() => { this.toggle('1'); }}>
                <center className="maintext pl-1 pr-1">Text</center>
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink style = {{ borderTopLeftRadius: "10px",  borderTopRightRadius: "10px", 
          fontSize: "16px", padding: "15px 10px"}}
                ...
                <center className="maintext pl-1 pr-1">Username</center>
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink style = {{ borderTopLeftRadius: "10px",  borderTopRightRadius: "10px", 
           padding: "15px 10px"}}
                ...
                <center className="maintext pl-1 pr-1">Keyword</center>
              </NavLink>
            </NavItem>
          </Nav>
          ...
          {detailInfo2arr && <ResultUser data={detailInfo2arr} />}
          {detailInfo3arr && <ResultKeyword data={detailInfo3arr} />}
        </div>
      );
    }
  }
